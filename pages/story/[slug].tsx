...
export default function Story({ root, item, content }: Props) {
...
/**
 * Lists the slugs of all available story pages.
 */
...
/**
 * Return details for a story page with the specified slug.
 */
...
/**
 * Reads the /story directory and transforms it into a tree of items. The "slug" of the item is...
...
function getRoot(): ItemWithFile {
  const p = path.join(process.cwd(), "story")
